...
let currentStream;
let objectToDetect = objectSelect.value.toLowerCase(); // Initialisation à l'objet sélectionné

// Met à jour l'objet à détecter lorsque l'utilisateur sélectionne un objet dans la liste
